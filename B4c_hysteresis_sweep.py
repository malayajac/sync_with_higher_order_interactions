...
ThisDir = "B4c_OtherNets_hyst" #CHANGE THIS BY HAND!!!
...
# K1_List = np.linspace(0.0, 2.0, 21)
...
#----------------------------------------
# Forward sweep:
OutFileName_forward = f"{OrdParamDir}/{ThisDir}_forward_r_data_net{network_index}_omega{ic_omega}_theta{ic_theta}_K2_{kk2}.csv"
...
#----------------------------------------
# Backward sweep:
OutFileName_backward = f"{OrdParamDir}/{ThisDir}_backward_r_data_net{network_index}_omega{ic_omega}_theta{ic_theta}_K2_{kk2}.csv"
