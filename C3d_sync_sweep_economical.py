...
# This code looks at what happens to in the range K1=-2 to K1=2.
# This code saves only the first state and last state of each trajectory.
#------------------------------------------------------------
# How to run this code:
# python C3d_sync_sweep_economical.py <ic_omega> <ic_theta> <kk2>
#------------------------------------------------------------
import numpy as np
...
SolDir = "{}_sol_economical".format(ThisDir)
...
#----------------------------------------
# Sweep:
OutFileName = f"{OrdParamDir}/{ThisDir}_r_data_omega{ic_omega}_theta{ic_theta}_K2_{kk2}.csv"
